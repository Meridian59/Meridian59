...
{"InsertListElem",      INSERTLISTELEM,  AEXPRESSION,   AEXPRESSION,  AEXPRESSION, ANONE},
...
{"GetAllListNodesByClass",GETALLLISTNODESBYCLASS, AEXPRESSION, AEXPRESSION, AEXPRESSION, ANONE},
{"ListCopy",            LISTCOPY,        AEXPRESSION,   ANONE},
{"Last",                LAST,            AEXPRESSION,   ANONE},
{"SendList",            SENDLISTMSG,     AEXPRESSION,   AEXPRESSION,  AEXPRESSION,
                                         ASETTINGS, ANONE},
{"SendListBreak",       SENDLISTMSGBREAK,AEXPRESSION,   AEXPRESSION,  AEXPRESSION,
                                         ASETTINGS, ANONE},
...
{"GetHeightFloorBSP",   GETHEIGHTFLOORBSP, AEXPRESSION, AEXPRESSION, AEXPRESSION,
                                           AEXPRESSION, AEXPRESSION, ANONE },
{"GetHeightCeilingBSP", GETHEIGHTCEILINGBSP, AEXPRESSION, AEXPRESSION, AEXPRESSION,
                                             AEXPRESSION, AEXPRESSION, ANONE },
{"IsInThingsBoxBSP",    ISINTHINGSBOXBSP, AEXPRESSION, AEXPRESSION, AEXPRESSION,
                                          AEXPRESSION, AEXPRESSION, ANONE },
{"CanMoveInRoomBSP",    CANMOVEINROOMBSP, AEXPRESSION, AEXPRESSION, AEXPRESSION,
         AEXPRESSION, AEXPRESSION, AEXPRESSION, AEXPRESSION, AEXPRESSION, AEXPRESSION, ANONE },
{"LineOfSightBSP",      LINEOFSIGHTBSP, AEXPRESSION, AEXPRESSION, AEXPRESSION,
         AEXPRESSION, AEXPRESSION, AEXPRESSION, AEXPRESSION, AEXPRESSION, AEXPRESSION, ANONE },
{"ChangeTextureBSP",    CHANGETEXTUREBSP, AEXPRESSION, AEXPRESSION, AEXPRESSION, AEXPRESSION, ANONE },
{"MoveSectorBSP",       MOVESECTORBSP,   AEXPRESSION,   AEXPRESSION,  AEXPRESSION, AEXPRESSION, AEXPRESSION, ANONE },
{"BlockerAddBSP",       BLOCKERADDBSP,   AEXPRESSION,   AEXPRESSION,  AEXPRESSION, AEXPRESSION,
                                         AEXPRESSION,   AEXPRESSION,  ANONE },
{"BlockerMoveBSP",      BLOCKERMOVEBSP,  AEXPRESSION,   AEXPRESSION,  AEXPRESSION, AEXPRESSION,
                                         AEXPRESSION,   AEXPRESSION,  ANONE },
{"BlockerRemoveBSP",    BLOCKERREMOVEBSP, AEXPRESSION,  AEXPRESSION,  ANONE },
{"BlockerClearBSP",     BLOCKERCLEARBSP, AEXPRESSION,   ANONE },
{"GetRandomPointBSP",   GETRANDOMPOINTBSP, AEXPRESSION, AEXPRESSION,  AEXPRESSION, AEXPRESSION, AEXPRESSION, AEXPRESSION, ANONE },
{"GetStepTowardsBSP",   GETSTEPTOWARDSBSP, AEXPRESSION, AEXPRESSION,  AEXPRESSION, AEXPRESSION, AEXPRESSION,
