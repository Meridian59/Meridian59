                    ...
                    int num_blak_parm,parm_node blak_parm[])
{
	...
	for (count=0;count<num_show;count++)
	{
		...
		switch (max_index)
		{
		case CREATEOBJECT : strncpy(c_name, "CreateObject", sizeof(c_name)); break;
		case ISCLASS : strncpy(c_name, "IsClass", sizeof(c_name)); break;
		case GETCLASS : strncpy(c_name, "GetClass", sizeof(c_name)); break;
		case SENDMESSAGE : strncpy(c_name, "Send", sizeof(c_name)); break;
		case POSTMESSAGE : strncpy(c_name, "Post", sizeof(c_name)); break;
		case DEBUG : strncpy(c_name, "Debug", sizeof(c_name)); break;
		case ADDPACKET : strncpy(c_name, "AddPacket", sizeof(c_name)); break;
		case SENDPACKET : strncpy(c_name, "SendPacket", sizeof(c_name)); break;
		case SENDCOPYPACKET : strncpy(c_name, "SendCopyPacket", sizeof(c_name)); break;
		case CLEARPACKET : strncpy(c_name, "ClearPacket", sizeof(c_name)); break;
		case GETINACTIVETIME : strncpy(c_name, "GetInactiveTime", sizeof(c_name)); break;
		case STRINGEQUAL : strncpy(c_name, "StringEqual", sizeof(c_name)); break;
		case STRINGCONTAIN : strncpy(c_name, "StringContain", sizeof(c_name)); break;
		case SETRESOURCE : strncpy(c_name, "SetResource", sizeof(c_name)); break;
		case PARSESTRING : strncpy(c_name, "ParseString", sizeof(c_name)); break;
		case SETSTRING : strncpy(c_name, "SetString", sizeof(c_name)); break;
		case CREATESTRING : strncpy(c_name, "CreateString", sizeof(c_name)); break;
		case STRINGSUBSTITUTE : strncpy(c_name, "StringSubstitute", sizeof(c_name)); break;
		case APPENDTEMPSTRING : strncpy(c_name, "AppendTempString", sizeof(c_name)); break;
		case CLEARTEMPSTRING : strncpy(c_name, "ClearTempString", sizeof(c_name)); break;
		case GETTEMPSTRING : strncpy(c_name, "GetTempString", sizeof(c_name)); break;
		case STRINGLENGTH : strncpy(c_name, "StringLength", sizeof(c_name)); break;
		case STRINGCONSISTSOF : strncpy(c_name, "StringConsistsOf", sizeof(c_name)); break;
		case CREATETIMER : strncpy(c_name, "CreateTimer", sizeof(c_name)); break;
		case DELETETIMER : strncpy(c_name, "DeleteTimer", sizeof(c_name)); break;
		case GETTIMEREMAINING : strncpy(c_name, "GetTimeRemaining", sizeof(c_name)); break;
		case CREATEROOMDATA : strncpy(c_name, "CreateRoomData", sizeof(c_name)); break;
		case ROOMDATA : strncpy(c_name, "RoomData", sizeof(c_name)); break;
		case CANMOVEINROOM : strncpy(c_name, "CanMoveInRoom", sizeof(c_name)); break;
		case CANMOVEINROOMFINE : strncpy(c_name, "CanMoveInRoomFine", sizeof(c_name)); break;
		case MINIGAMENUMBERTOSTRING : strncpy(c_name, "MinigameNumberToString", sizeof(c_name)); break;
		case MINIGAMESTRINGTONUMBER : strncpy(c_name, "MinigameStringToNumber", sizeof(c_name)); break;
		case CONS : strncpy(c_name, "Cons", sizeof(c_name)); break;
		case FIRST : strncpy(c_name, "First", sizeof(c_name)); break;
		case REST : strncpy(c_name, "Rest", sizeof(c_name)); break;
		case LENGTH : strncpy(c_name, "Length", sizeof(c_name)); break;
		case NTH : strncpy(c_name, "Nth", sizeof(c_name)); break;
		case LIST : strncpy(c_name, "List", sizeof(c_name)); break;
		case ISLIST : strncpy(c_name, "IsList", sizeof(c_name)); break;
		case SETFIRST : strncpy(c_name, "SetFirst", sizeof(c_name)); break;
		case SETNTH : strncpy(c_name, "SetNth", sizeof(c_name)); break;
		case DELLISTELEM : strncpy(c_name, "DelListElem", sizeof(c_name)); break;
		case FINDLISTELEM : strncpy(c_name, "FindListElem", sizeof(c_name)); break;
		case MOVELISTELEM : strncpy(c_name, "MoveListElem", sizeof(c_name)); break;
		case GETTIME : strncpy(c_name, "GetTime", sizeof(c_name)); break;
		case ABS : strncpy(c_name, "Abs", sizeof(c_name)); break;
		case BOUND : strncpy(c_name, "Bound", sizeof(c_name)); break;
		case SQRT : strncpy(c_name, "Sqrt", sizeof(c_name)); break;
		case CREATETABLE : strncpy(c_name, "CreateTable", sizeof(c_name)); break;
		case ADDTABLEENTRY : strncpy(c_name, "AddTableEntry", sizeof(c_name)); break;
		case GETTABLEENTRY : strncpy(c_name, "GetTableEntry", sizeof(c_name)); break;
		case DELETETABLEENTRY : strncpy(c_name, "DeleteTableEntry", sizeof(c_name)); break;
		case DELETETABLE : strncpy(c_name, "DeleteTable", sizeof(c_name)); break;
		case ISOBJECT : strncpy(c_name, "IsObject", sizeof(c_name)); break;
		case RECYCLEUSER : strncpy(c_name, "RecycleUser", sizeof(c_name)); break;
		case RANDOM : strncpy(c_name, "Random", sizeof(c_name)); break;
