...
enum
{
   ...
   INACTIVE_OVERRIDE, INACTIVE_MAINTENANCE,
   ...
   AUTO_REOPEN_CHANNELS_TIME, AUTO_REOPEN_CHANNELS_PERIOD,
   ...
   UPDATE_PACKAGE_PATH, UPDATE_DOWNLOAD_REASON, UPDATE_DEMO_BUTTON, UPDATE_MOVE_INTERVAL,
   ...
   DEBUG_HASH, DEBUG_INITPROPERTIES, DEBUG_INITLOCALS,
   DEBUG_UNINITIALIZED,
