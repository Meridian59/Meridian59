...
{ 
   ...
   DEBUG_GROUP,
   DEBUG_SMTP, DEBUG_CANMOVEINROOM, DEBUG_CANMOVEINROOMHIGHRES, DEBUG_HEAP, DEBUG_TRANSMITTED_BYTES,
   DEBUG_HASH, DEBUG_PORTAL, DEBUG_INITLOCALS,
   DEBUG_UNINITIALIZED, DEBUG_TIME_CALLS,
