...
static char INILagboxLive[]  = "LatencyMeterLive";
...
void ConfigLoad(void)
{
   ...
   config.lagbox_live  = GetConfigInt(interface_section, INILagbox, False, ini_file);
...
void ConfigSave(void)
{
  ...
  char ignore_string[MAX_IGNORE_LIST * (MAX_CHARNAME + 1) + 1];
   ...
   WriteConfigInt(interface_section, INILagboxLive, config.lagbox_live, ini_file);
