...
/////////////////////////////////////////////////////////////////////////////
// CInteractionPage property page

IMPLEMENT_DYNCREATE(CInteractionPage, CPropertyPage)

CInteractionPage::CInteractionPage() : CPropertyPage(CInteractionPage::IDD)
{
	//{{AFX_DATA_INIT(CInteractionPage)
	//}}AFX_DATA_INIT
}

CInteractionPage::~CInteractionPage()
{
}

void CInteractionPage::DoDataExchange(CDataExchange* pDX)
{
	CPropertyPage::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CInteractionPage)
...
/////////////////////////////////////////////////////////////////////////////
// CInteractionPage message handlers
void CInteractionPage::UpdateDialogData()
{
...
BOOL CInteractionPage::OnInitDialog()
{
...
void CInteractionPage::ProcessModifierPressed(TCHAR* TCString, int nID, HWND m_hWnd)
{
	CModifier dlg;
