# Microsoft Developer Studio Generated NMAKE File, Based on ezrgb24.dsp
!IF "$(CFG)" == ""
CFG=ezrgb24 - Win32 Debug
!MESSAGE No configuration specified. Defaulting to ezrgb24 - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "ezrgb24 - Win32 Release" && "$(CFG)" != "ezrgb24 - Win32 Debug"
...
ALL : "$(OUTDIR)\ezrgb24.ax"


CLEAN :
	-@erase "$(INTDIR)\ezprop.obj"
	-@erase "$(INTDIR)\ezprop.res"
	-@erase "$(INTDIR)\ezrgb24.obj"
	-@erase "$(OUTDIR)\ezrgb24.ax"
	-@erase "$(OUTDIR)\ezrgb24.exp"
	-@erase "$(OUTDIR)\ezrgb24.lib"
...
!IF EXISTS("ezrgb24.dep")
!INCLUDE "ezrgb24.dep"
!ELSE 
!MESSAGE Warning: cannot find "ezrgb24.dep"
!ENDIF 
!ENDIF 
...
"$(INTDIR)\ezrgb24.obj" : $(SOURCE) "$(INTDIR)"
