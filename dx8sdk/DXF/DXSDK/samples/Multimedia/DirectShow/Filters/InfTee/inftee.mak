# Microsoft Developer Studio Generated NMAKE File, Based on inftee.dsp
!IF "$(CFG)" == ""
CFG=inftee - Win32 Debug
!MESSAGE No configuration specified. Defaulting to inftee - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "inftee - Win32 Release" && "$(CFG)" != "inftee - Win32 Debug"
!MESSAGE Invalid configuration "$(CFG)" specified.
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "inftee.mak" CFG="inftee - Win32 Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "inftee - Win32 Release" (based on "Win32 (x86) Dynamic-Link Library")
!MESSAGE "inftee - Win32 Debug" (based on "Win32 (x86) Dynamic-Link Library")
!MESSAGE 
...
ALL : "$(OUTDIR)\inftee.ax"


CLEAN :
	-@erase "$(INTDIR)\inftee.obj"
	-@erase "$(INTDIR)\inftee.res"
	-@erase "$(OUTDIR)\inftee.ax"
	-@erase "$(OUTDIR)\inftee.exp"
	-@erase "$(OUTDIR)\inftee.lib"
...
RSC=rc.exe
RSC_PROJ=/l 0x409 /fo"$(INTDIR)\inftee.res" /i "..\..\BaseClasses" /d "NDEBUG" 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\inftee.bsc" 
BSC32_SBRS= \
	
LINK32=link.exe
LINK32_FLAGS=..\..\BaseClasses\release\strmbase.lib msvcrt.lib quartz.lib vfw32.lib winmm.lib kernel32.lib advapi32.lib version.lib largeint.lib user32.lib gdi32.lib comctl32.lib ole32.lib olepro32.lib oleaut32.lib uuid.lib /nologo /entry:"DllEntryPoint@12" /dll /pdb:none /machine:I386 /nodefaultlib /def:".\inftee.def" /out:"$(OUTDIR)\inftee.ax" /implib:"$(OUTDIR)\inftee.lib" /libpath:"..\..\..\..\lib" /subsystem:windows,4.0 /opt:ref /release /debug:none /OPT:NOREF /OPT:ICF /stack:0x200000,0x200000
LINK32_OBJS= \
	"$(INTDIR)\inftee.obj" \
	"$(INTDIR)\inftee.res"

"$(OUTDIR)\inftee.ax" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<

!ELSEIF  "$(CFG)" == "inftee - Win32 Debug"
...
RSC=rc.exe
RSC_PROJ=/l 0x409 /fo"$(INTDIR)\inftee.res" /i "..\..\BaseClasses" /d "_DEBUG" 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\inftee.bsc" 
BSC32_SBRS= \
...
!IF EXISTS("inftee.dep")
!INCLUDE "inftee.dep"
!ELSE 
!MESSAGE Warning: cannot find "inftee.dep"
!ENDIF 
!ENDIF 
...
"$(INTDIR)\inftee.obj" : $(SOURCE) "$(INTDIR)"


SOURCE=.\inftee.rc

"$(INTDIR)\inftee.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) $(RSC_PROJ) $(SOURCE)
