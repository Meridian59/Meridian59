...
protected:
    ...
    int m_iPins;                          // The number of pins on this filter. Updated by CDynamicSourceStream
...
public:
    ...
    CDynamicSourceStream(CHAR *pObjectName,
                         ...
                         LPCWSTR pName);
#endif
    virtual ~CDynamicSourceStream(void);  // virtual destructor ensures derived class destructors are called too.
