...
#define BF_POS_TEX_CLAMP     0x40000000      // + side texture clamp
#define BF_NEG_TEX_CLAMP     0x80000000      // - side texture clamp
...
#define WF_TEX_CLAMP      0x00020000      // Clamp texture
