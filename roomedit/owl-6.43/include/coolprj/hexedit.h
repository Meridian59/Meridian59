...
//{{THexViewWndRSP_TBL_BEGIN}}
    ...
    bool EvMouseWheel(owl::uint modKeys, int zDelta, const owl::TPoint& point);
...
//{{THexEditViewVIRTUAL_BEGIN}}
    bool     CanClose();
    LPCTSTR  GetViewName();
    owl::TWindow* GetWindow();
    bool     SetDocTitle(LPCTSTR docname, int index);
//{{THexEditViewVIRTUAL_END}}

//{{THexEditViewRSP_TBL_BEGIN}}
  protected:
    bool     VnIsWindow(HWND hWnd);
//{{THexEditViewRSP_TBL_END}}
