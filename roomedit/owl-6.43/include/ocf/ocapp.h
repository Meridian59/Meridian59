...
class _OCFCLASS TOcRegistrar : public TRegistrar {
  public:
    TOcRegistrar(owl::TRegList& regInfo, TComponentFactory callback,
                                owl::tstring& cmdLine, owl::TRegLink* linkHead = 0,
...
// !CQ    owl::uint32 ForwardEvent(int eventId, const void * param);
// !CQ    owl::uint32 ForwardEvent(int eventId, owl::uint32 param = 0);
