...
/* owllink.h is basically a #pragma that force-links the OWL library
   with a name derived from various versions, including that of the compiler,
   making it very hard to incorporate into our makefiles.  It's not needed.
   akirmse 2018-01-19
