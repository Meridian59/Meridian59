...
#if (__BORLANDC__ >= 0x720) // 10.1 Berlin
#define OWL_LIB_COMPILER_VERSION "720"
#elif (__BORLANDC__ >= 0x710) // 10 Seattle
#define OWL_LIB_COMPILER_VERSION "710"
#elif (__BORLANDC__ >= 0x700) // XE8
#define OWL_LIB_COMPILER_VERSION "19"
#elif (__BORLANDC__ >= 0x690) // XE7
...
#else
#error OWLNext: Unsupported compiler version.
#endif
...
#define OWL_LIB_COMPILER_VERSION "710"
#elif (__BORLANDC__ >= 0x700) // XE8
#define OWL_LIB_COMPILER_VERSION "700"
#else
#error OWLNext: Unsupported compiler version.
#endif
