...
class OWLEXTCLASS THarborEx : public owl::THarbor
{
  ...
  protected:
    ...
    virtual owl::TEdgeSlip* ConstructEdgeSlip(owl::TDecoratedFrame& df, owl::TAbsLocation location);
    // Factory function overridden to use TEdgeSlipEx in lace of TEdgeSlip

    virtual owl::TFloatingSlip* ConstructFloatingSlip(owl::TDecoratedFrame& df,
      int x, int y, owl::TWindow* dockableWindow);
