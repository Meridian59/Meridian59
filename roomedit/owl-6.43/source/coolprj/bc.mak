#-----------------------------------------------------------------------------
# bc.mak - makefile for building CoolPrj
#
...
CDEFINES       = -D_COOLPRJPCH -DINC_OLE2 -D_OWLPCH
PCHFILE		   = "coolprj\pch.h"

!if $d(DLL)
DLLCDEFS     = -D_BUILDCOOLPRJDLL -D_OWLDLL -D_RTLDLL 
LIBDLL_DEFS    = -D_OWLDLL -D_COOLPRJDLL
LIBDLL_UNDEFS  = -U_BUILDCOOLPRJDLL
!else
LIBCDEFS     = -DBUILD_COOLPRJLIB
!endif
...
# VH, May 2006:
# The resource file (coolprj.res) needs preprocessing of "version.rc".
...
# Then "coolprj.rc" will include "version.i" instead (see "coolprj.rc").

version.i: version.rc $(ROOTDIR)\include\coolprj\version.h
