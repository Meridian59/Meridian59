...
TCoolTextBuffer::GetDefSyntaxDescr(int index)
{
  static TSyntaxDescr array[] = {
    TSyntaxDescr(TColor::SysWindowText,       TColor::SysWindow,         0), //COLORINDEX_WHITESPACE
    // Normal Text
    TSyntaxDescr(TColor::SysWindowText,       TColor::SysWindow,         0), //COLORINDEX_NORMALTEXT
    // Margin
    TSyntaxDescr(TColor::Black,               TColor::SysScrollbar,      0), //COLORINDEX_MARGIN
    // Selected Text
    TSyntaxDescr(TColor::White,               TColor::Black,             0), //COLORINDEX_SELECTION
    // Syntax Check
    TSyntaxDescr(TColor::SysWindowText,       TColor::LtRed,             0), //COLORINDEX_SINTAXCHECK
    //  Syntax colors
    TSyntaxDescr(TColor::LtBlue,              TColor::SysWindow,         1), //COLORINDEX_KEYWORD
    TSyntaxDescr(TColor(CLR_NEWMIDNIGHTBLUE), TColor::LtGray,            0), //COLORINDEX_COMMENT
    TSyntaxDescr(TColor::LtMagenta,           TColor::SysWindow,         0), //COLORINDEX_NUMBER
    TSyntaxDescr(TColor::LtRed,               TColor::SysWindow,         0), //COLORINDEX_OPERATOR
    TSyntaxDescr(TColor::LtBlue,              TColor::LtCyan,            0), //COLORINDEX_STRING
    TSyntaxDescr(TColor::Black,               TColor::LtCyan,            0), //COLORINDEX_CHARACTER
    TSyntaxDescr(TColor::LtMagenta,           TColor::SysWindow,         0), //COLORINDEX_PREPROCESSOR
    TSyntaxDescr(TColor::Black,               TColor::SysWindow,         1), //COLORINDEX_FUNCNAME
    //Compiler/debugger colorsrs
    TSyntaxDescr(TColor::LtRed,               TColor::LtYellow,           0), //COLORINDEX_ERROR
    TSyntaxDescr(TColor::Black,               TColor(0, 128, 0),          0), //COLORINDEX_EXECUTION
    TSyntaxDescr(TColor::Black,               TColor::LtRed,              0), //COLORINDEX_BREAKPOINT
    TSyntaxDescr(TColor(128, 128, 0),         TColor::LtYellow,           0), //COLORINDEX_INVALIDBREAK
    //Expandable: custom elements are allowed.ments are allowed.
    TSyntaxDescr(TColor::SysWindowText,       TColor::SysWindow,          0), //COLORINDEX_CUSTOM0
    TSyntaxDescr(TColor::SysWindowText,       TColor::SysWindow,          0), //COLORINDEX_CUSTOM1
    TSyntaxDescr(TColor::SysWindowText,       TColor::SysWindow,          0), //COLORINDEX_CUSTOM2
    TSyntaxDescr(TColor::SysWindowText,       TColor::SysWindow,          0), //COLORINDEX_CUSTOM3
    TSyntaxDescr(TColor::SysWindowText,       TColor::SysWindow,          0), //COLORINDEX_CUSTOM4
    TSyntaxDescr(TColor::SysWindowText,       TColor::SysWindow,          0), //COLORINDEX_CUSTOM5
    TSyntaxDescr(TColor::SysWindowText,       TColor::SysWindow,          0), //COLORINDEX_CUSTOM6
    TSyntaxDescr(TColor::SysWindowText,       TColor::SysWindow,          0), //COLORINDEX_CUSTOM7
    TSyntaxDescr(TColor::SysWindowText,       TColor::SysWindow,          0), //COLORINDEX_CUSTOM8
    TSyntaxDescr(TColor::SysWindowText,       TColor::SysWindow,          0), //COLORINDEX_CUSTOM9
  };
            ...
            bool caseSensitive, bool wholeWord, bool up)
{
  ...
  //
  if(pos)
    return TEditPos(pos - buffer, lineIndex);
  return TEditPos();
}
//-----------------------------------------------------------------------------
//
...
TCoolFileBuffer::Save(TFile& file, TCrLfStyle style, bool clearDirty)
{
  ...
  int CRLFLength = _tcsclen(pszCRLF);
...
TCoolTextWnd::TTextSelection::Copy()
{
  ...
  if (clipboard.EmptyClipboard()){
    ...
    if(Copy(ostrm)){
      retval = TextToClipboard(clipboard, ostrm.str().c_str(), _tcslen(ostrm.str().c_str()));
    }
  }
  return retval;
}
...
//-----------------------------------------------------------------------------
TWindow::TGetClassNameReturnType TCoolTextWnd::GetClassName()
{
  return _T("COOLEDIT");
}
//-----------------------------------------------------------------------------
...
TCoolTextWnd::DrawMargin(TDC& dc, const TRect& rect, int lineIndex)
{
  if(!IsSelectionMargin()){
    ...
    dc.ExtTextOut(0, 0, ETO_OPAQUE, &rect, _T(""), 0);
    return;
  }
  ...
  dc.ExtTextOut(0, 0, ETO_OPAQUE, &imageRect, _T(""), 0);
...
TCoolTextWnd::DrawLine(TDC& dc, const TRect& rect, int lineIndex)
{
  ...
  if (!length){
    ...
    if(IsFlagSet(cfFocused|cfShowInactiveSel) && IsInSelection(editPos)){
      ...
      dc.ExtTextOut(0, 0, ETO_OPAQUE, &rc, _T(""), 0);
      r.left += GetCharWidth();
    }
    dc.SetBkColor(GetBkColor(drawWhitespace ? colorIdx : COLORINDEX_WHITESPACE));
    dc.ExtTextOut(0, 0, ETO_OPAQUE, &r, _T(""), 0);
    return;
  }
  ...
  if (frect.right > frect.left){
    ...
    if(frect.right > frect.left){
      dc.SetBkColor(GetBkColor(drawWhitespace ? colorIdx : COLORINDEX_WHITESPACE));
      dc.ExtTextOut(0, 0, ETO_OPAQUE, &frect, _T(""), 0);
    }
  }
}
//
...
TCoolTextWnd::EvSetCursor(HWND hWndCursor, uint hitTest, uint mouseMsg)
{
  if (hitTest == HTCLIENT){
    ...
    uint lineCurb = CurbPos==-1 ? -1 : ((CurbPos-GetOffsetChar())*GetCharWidth()+GetMarginWidth());
...
TCoolTextWnd::Text2Client(const TEditPos& pos)
{
  PRECONDITION(GetBuffer());
  //  VERIFY_TEXTPOS(pos);
  int length = GetLineLength(pos.row);
...
TCoolTextWnd::GetLineActualLength(int lineIndex)
{
  ...
  if(length > 0){
    ...
    for (;;){
      ...
      if (!psz){
        actualLength += (pszChars + length - pszCurrent);
        break;
      }

      actualLength += (psz - pszCurrent);
...
{
  bool retval = Inherited::EvMouseWheel(modKeys, zDelta, point);
  if(retval && IsFlagSet(cfHasCaret))
    SetCaretPos(Text2Client(CursorPos));
  return retval;
}
//
...
TCoolTextWnd::NextBreak(const TEditPos& pos)
{
  ...
  if(isBreakChar){
    ...
    size_t npos = len>0 ? _tcscspn(&pszChars[nPos], breakChars) : 0;
    if(npos)
      nPos += npos;
    else
...
{
  CHECK(de == DROPEFFECT_COPY);
  //_TRACE("TCoolTextWnd::DropSource\n");
}
//
void
TCoolTextWnd::DropText(IDataObject* src, const TPoint& point, DROPEFFECT de)
{
...
TBruteForceEngine::Search(TCoolTextBuffer& buffer,const TEditRange& searchRange)
{
  ...
  return
    resPos.Valid()
    ?
    TEditRange(resPos.col,resPos.row,resPos.col+Pattern.length(),resPos.row)
    :
  TEditRange();
}
//-----------------------------------------------------------------------------
...
TBoyerMooreEngine::Search(TCoolTextBuffer& buffer, const TEditRange& _range)
{
  ...
  //
  if(pos)
    return TEditRange(pos-text, lineIndex, pos-text+Pattern.length(),lineIndex);
  return TEditRange();
}
//-----------------------------------------------------------------------------
...
TRegularExEngine::Search(TCoolTextBuffer& buffer, const TEditRange& _sRange)
{
  ...
  if(endp)
    return TEditRange(startp - text, lineIndex, endp - text + 1, lineIndex);
  return TEditRange();
}
...
#define MT_noghf(x)  (vsvfn[(x) - _T('A')] & 16) /* BDH      */
  ...
  */
  bool metaphone(const _TCHAR* Word, _TCHAR* Metaph, metaphlag flag)
  {
    ...
    _TCHAR *metaph, *metaph_end;    /* Pointers to metaph               */
  ...
  DirectUp(up)
  {
    ...
    size_t pos = Pattern.find_first_not_of(_T(' '));
    if (pos != Pattern.npos)
      Pattern.erase(0, pos);
    ...
    TPhoneticEngine::Search(TCoolTextBuffer& buffer,const TEditRange& _sRange)
  {
    ...
    while(true){
      ...
      if(endp){
        ...
        range.scol = endp - buffer.GetLineText(lineIndex);
    ...
    TFuzzyEngine::Search(TCoolTextBuffer& buffer,const TEditRange& _sRange)
  {
    ...
    while(true){
      ...
      if(textBegin){
        range.srow = range.erow = lineIndex;
        range.scol = textBegin - buffer.GetLineText(lineIndex);
        range.ecol = range.scol + textEnd - textBegin;
        break;
      }
      if(DirectUp){
        lineIndex--;
  ...
  //
  TRedoInsertChar::TRedoInsertChar(TCoolEdit& wnd)
  { }
  //
  bool
    TRedoInsertChar::Redo(TCoolTextBuffer& buffer, TEditPos* newPos)
  { return true; }
  //
  bool
    TRedoInsertChar::GetDescription(_TCHAR* buffer, int len, TModule* module)
  { return true; }
  //////////////////////////////////////////////////////////////////////////////////////
  //-----------------------------------------------------------
  ...
  //
  TRedoKeyEnter::TRedoKeyEnter(TCoolEdit& wdn)
  {}
  bool TRedoKeyEnter::Redo(TCoolTextBuffer& buffer, TEditPos* newPos)
  { return true;}
  bool TRedoKeyEnter::GetDescription(_TCHAR* buffer, int len, TModule* module)
  { return true;}
  //////////////////////////////////////////////////////////////////////////////////////////
  ...
  //
  TUndoKeyTab::TUndoKeyTab(TCoolEdit& wnd, const TEditPos& pos,
  ...
  //
  TRedoKeyTab::TRedoKeyTab(TCoolEdit& end)
  {}
  bool TRedoKeyTab::Redo(TCoolTextBuffer& buffer, TEditPos* newPos)
  { return true;}
  bool TRedoKeyTab::GetDescription(_TCHAR* buffer, int len, TModule* module)
  { return true;}
  //////////////////////////////////////////////////////////////////////////////////////////
  ...
  //
  TRedoKeyTabify::TRedoKeyTabify(TCoolEdit& end)
  {}
  bool TRedoKeyTabify::Redo(TCoolTextBuffer& buffer, TEditPos* newPos)
  { return true;}
  bool TRedoKeyTabify::GetDescription(_TCHAR* buffer, int len, TModule* module)
  {   return true;}
  //////////////////////////////////////////////////////////////////////////////////////////
  //TUndoDeleteChar
  ...
  //
  TRedoDeleteChar::TRedoDeleteChar(TCoolEdit& end)
  {}
  ...
  //
  TRedoDeleteWord::TRedoDeleteWord(TCoolEdit& end)
  {}
  bool TRedoDeleteWord::Redo(TCoolTextBuffer& buffer, TEditPos* newPos)
  { return true;}
  bool TRedoDeleteWord::GetDescription(_TCHAR* buffer, int len, TModule* module)
  { return true;}
  //////////////////////////////////////////////////////////////////////////////////////////
  ...
  //
  TRedoDeleteCharBack::TRedoDeleteCharBack(TCoolEdit& end)
  {}
  bool TRedoDeleteCharBack::Redo(TCoolTextBuffer& buffer, TEditPos* newPos)
  { return true;}
  bool TRedoDeleteCharBack::GetDescription(_TCHAR* buffer, int len, TModule* module)
  { return true;}
  //-----------------------------------------------------------
  ...
  //
  TRedoDeleteWordBack::TRedoDeleteWordBack(TCoolEdit& end)
  {}
  bool TRedoDeleteWordBack::Redo(TCoolTextBuffer& buffer, TEditPos* newPos)
  { return true;}
  bool TRedoDeleteWordBack::GetDescription(_TCHAR* buffer, int len, TModule* module)
  { return true;}
  //-----------------------------------------------------------
  ...
  bool TUndoDeleteSelection::Undo(TCoolTextBuffer& buffer, TEditPos* newPos)
  {
    ...
    pMemory += IdSelSize;
    PasteFromMemoryImp(pMemory, _tcslen(pMemory), selection, StartPos, buffer);
  ...
  //
  TRedoDeleteSelection::TRedoDeleteSelection(TCoolEdit& end)
  {}
  bool TRedoDeleteSelection::Redo(TCoolTextBuffer& buffer, TEditPos* newPos)
  { return true;}
  bool TRedoDeleteSelection::GetDescription(_TCHAR* buffer, int len, TModule* module)
  { return true;}
  //-----------------------------------------------------------
  // class TUndoPaste
  // ~~~~~ ~~~~~~~~~~
  ...
  //
  TRedoPaste::TRedoPaste(TCoolEdit& end)
  {}
  bool TRedoPaste::Redo(TCoolTextBuffer& buffer, TEditPos* newPos)
  { return true;}
  bool TRedoPaste::GetDescription(_TCHAR* buffer, int len, TModule* module)
  { return true;}
  //////////////////////////////////////////////////////////////////////////////////////////
  //TUndoClearAll(this);
  ...
  //
  TRedoClearAll::TRedoClearAll(TCoolEdit& end)
  {}
  bool TRedoClearAll::Redo(TCoolTextBuffer& buffer, TEditPos* newPos)
  { return true;}
  bool TRedoClearAll::GetDescription(_TCHAR* buffer, int len, TModule* module)
  { return true;}
  /////////////////////////////////////////////////////////////////////////////////////////////
#if !defined(COOL_NODRAGDROP)
  //-----------------------------------------------------------
  ...
  //
  TRedoDragDropMoveExt::TRedoDragDropMoveExt(TCoolEdit& end)
  {}
  bool TRedoDragDropMoveExt::Redo(TCoolTextBuffer& buffer, TEditPos* newPos)
  { return true;}
  bool TRedoDragDropMoveExt::GetDescription(_TCHAR* buffer, int len, TModule* module)
  { return true;}
  //-----------------------------------------------------------
  ...
  //
  TRedoDragDropCopy::TRedoDragDropCopy(TCoolEdit& end)
  {}
  bool TRedoDragDropCopy::Redo(TCoolTextBuffer& buffer, TEditPos* newPos)
  { return true;}
  bool TRedoDragDropCopy::GetDescription(_TCHAR* buffer, int len, TModule* module)
  { return true;}
  //-----------------------------------------------------------
  ...
  //
  TRedoDragDropMove::TRedoDragDropMove(TCoolEdit& end)
  {}
  bool TRedoDragDropMove::Redo(TCoolTextBuffer& buffer, TEditPos* newPos)
  { return true;}
  bool TRedoDragDropMove::GetDescription(_TCHAR* buffer, int len, TModule* module)
  { return true;}
#endif
  /////////////////////////////////////////////////////////////////////////////////////////////
  //
  ...
  // ~~~~~ ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  //
  static bool isCoolFormat(LPDATAOBJECT src, uint defFormat)
  {
    TFormatEtc fe(defFormat, TYMED_HGLOBAL);

    if(src->QueryGetData(&fe) == NOERROR)
      return true;
...
#endif
          if(ptr)
            PasteFromMemory(ptr, _tcslen(ptr), selection);
        }
        pMemory = 0;
      }
    }
    if(pMemory)
      PasteFromMemory(pMemory, _tcslen(pMemory), selection);
    ...
    TCoolEditFile::SetupWindow()
  {
    ...
    FileData.Flags = OFN_FILEMUSTEXIST|OFN_HIDEREADONLY|OFN_OVERWRITEPROMPT|OFN_LONGNAMES;
    //
