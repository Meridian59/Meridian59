...
//
bool
TDragDropProxy::PerformDrop(IDataObject* dataObj, const TPoint& point, DROPEFFECT de)
{
  return true;
}
//
...
//
void
TDragDropProxy::EndDragDrop(DROPEFFECT de)
{
    ...
    if (de.FormatEtc== *pFE){
      if(de.FormatEtc.tymed == TYMED_HGLOBAL){
        *pSTM = de.StgMedium;
        ...
        DWORD nSize = ::GlobalSize(de.StgMedium.hGlobal);
 ...
 */
STDMETHODIMP TDragDropProxy::GetCanonicalFormatEtc(LPFORMATETC pFEIn, LPFORMATETC pFEOut)
{
 ...
 */
STDMETHODIMP TDragDropProxy::DAdvise(LPFORMATETC pFE, DWORD dwFlags, LPADVISESINK pIAdviseSink, LPDWORD pdwConn)
{
 ...
 *                  enumerator.
 */
STDMETHODIMP TDragDropProxy::EnumDAdvise(LPENUMSTATDATA *ppEnum)
{
