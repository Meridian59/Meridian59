...
/// - \c \b  CF_BITMAP Data is a handle to a bitmap format
/// - \c \b  CF_DIB Data is memory bitmap with a BITMAPINFO structure
/// - \c \b  CF_DIBV5 Data is memory bitmap with a BITMAPV5HEADER structure
/// - \c \b  CF_DIF Data is in a Data Interchange Format (DIF).
/// - \c \b  CF_DSPBITMAP Data is a handle to a private bitmap format
/// - \c \b  CF_DSPENHMETAFILE Data is a handle to a private enhanced metafile.
/// - \c \b  CF_DSPMETAFILEPICT Data is in a private metafile format.
/// - \c \b  CF_DSPTEXT Data is in a private text format.
/// - \c \b  CF_ENHMETAFILE Data is a handle to an enhanced metafile.
/// - \c \b  CF_GDIOBJFIRST Data is the start of a range of integer values for application-defined GDI object clipboard formats.
/// - \c \b  CF_GDIOBJLAST Data is the last of a range of integer values for application-defined GDI object clipboard formats.
/// - \c \b  CF_HDROP Data is a handle to type HDROP that identifies a list of files.
/// - \c \b  CF_LOCALE Data is a handle to the locale identifier associated with the clipboard text.
...
/// - \c \b  CF_PRIVATEFIRST Data is the start of a range of integer values for private clipboard formats.
/// - \c \b  CF_PRIVATELAST Data is the last of a range of integer values for private clipboard formats.
...
/// - \c \b  CF_UNICODETEXT Data is stored as an array of Unicode text characters.
