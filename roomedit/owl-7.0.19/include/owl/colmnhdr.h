...
class _OWLCLASS THdrItem : public HD_ITEM {
  public:
    ...
    enum TAlign
    {
      aLeft = HDF_LEFT, ///< Aligns the contents at the left edge of the item.
      aCenter = HDF_CENTER, ///< Aligns the contents horizontally at the center of the item.
      aRight = HDF_RIGHT ///< Aligns the contens at the right edge of the item.
    };
    ...
    explicit THdrItem(LPCTSTR str, TAlign = aLeft);
    THdrItem(LPCTSTR str, HBITMAP hbm, TAlign = aLeft);
    explicit THdrItem(HBITMAP hbm, TAlign = aLeft);
