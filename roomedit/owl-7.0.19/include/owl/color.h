...
TColor::Flags() const
{
  return static_cast<uint8>(static_cast<uint16>((Value >> 24)));
}
...
{
  peRed = static_cast<uint8>(static_cast<uint16>(r));
  peGreen = static_cast<uint8>(static_cast<uint16>(g));
  peBlue = static_cast<uint8>(static_cast<uint16>(b));
  peFlags = static_cast<uint8>(static_cast<uint16>(f));
}
...
{
  rgbRed = static_cast<uint8>(static_cast<uint16>(r));
  rgbGreen = static_cast<uint8>(static_cast<uint16>(g));
  rgbBlue = static_cast<uint8>(static_cast<uint16>(b));
  rgbReserved = 0;
}
...
{
  rgbtRed = static_cast<uint8>(static_cast<uint16>(r));
  rgbtGreen = static_cast<uint8>(static_cast<uint16>(g));
  rgbtBlue = static_cast<uint8>(static_cast<uint16>(b));
}
