  ...
  : public TListBox
{
  public:
   ...
   ~TComboBox();
    ...
    auto GetButtonRect() const -> TRect {return GetInfo().rcButton;}
    auto GetButtonState() const -> uint {return GetInfo().stateButton;}

    // For combo box's edit subcontrol
    //
    auto GetEditHandle() const -> THandle {return GetInfo().hwndItem;}
    auto GetEditRect() const -> TRect {return GetInfo().rcItem;}
    ...
    //
    auto GetListHandle() const -> THandle {return GetInfo().hwndList;}
...
inline int TComboBox::SetEditSel(int startPos, int endPos) {
  PRECONDITION(GetHandle());
  return static_cast<int>(SendMessage(CB_SETEDITSEL, 0, MkParam2(startPos, endPos)));
}
...
inline bool TComboBox::GetDroppedState() const {
  PRECONDITION(GetHandle());
  return static_cast<bool>(CONST_CAST(TComboBox*,this)->SendMessage(CB_GETDROPPEDSTATE));
}
...
inline bool TComboBox::GetExtendedUI() const {
  PRECONDITION(GetHandle());
  return static_cast<bool>(CONST_CAST(TComboBox*,this)->SendMessage(CB_GETEXTENDEDUI));
}
...
inline int TComboBox::SetExtendedUI(bool extended) {
  PRECONDITION(GetHandle());
  return static_cast<bool>(SendMessage(CB_SETEXTENDEDUI, extended));
}
...
{
  PRECONDITION(GetHandle());
  return static_cast<uint>(CONST_CAST(TComboBox*,this)->SendMessage(CB_GETDROPPEDWIDTH));
}
...
inline int TComboBox::AddString(LPCTSTR str) {
  PRECONDITION(GetHandle());
  return static_cast<int>(SendMessage(CB_ADDSTRING, 0, TParam2(str)));
}
...
inline int TComboBox::InsertString(LPCTSTR str, int index) {
  PRECONDITION(GetHandle());
  return static_cast<int>(SendMessage(CB_INSERTSTRING, index, TParam2(str)));
}
...
inline int TComboBox::DirectoryList(uint attrs, LPCTSTR fileSpec) {
  PRECONDITION(GetHandle());
  return static_cast<int>(SendMessage(CB_DIR, attrs, TParam2(fileSpec)));
}
...
inline int TComboBox::GetCount() const {
  PRECONDITION(GetHandle());
  return static_cast<int>(CONST_CAST(TComboBox*,this)->SendMessage(CB_GETCOUNT));
}
...
inline int TComboBox::FindString(LPCTSTR find, int startIndex) const {
  PRECONDITION(GetHandle());
  return static_cast<int>(CONST_CAST(TComboBox*,this)->
...
inline int TComboBox::GetTopIndex() const {
  PRECONDITION(GetHandle());
  return static_cast<int>(CONST_CAST(TComboBox*,this)->SendMessage(CB_GETTOPINDEX));
}
...
inline int TComboBox::GetHorizontalExtent() const {
  PRECONDITION(GetHandle());
  return static_cast<int>(CONST_CAST(TComboBox*,this)->SendMessage(CB_GETHORIZONTALEXTENT));
}
...
inline int TComboBox::GetSelIndex() const {
  PRECONDITION(GetHandle());
  return static_cast<int>(CONST_CAST(TComboBox*,this)->SendMessage(CB_GETCURSEL));
}
...
inline int TComboBox::SetSelString(LPCTSTR findStr, int startIndex) {
  PRECONDITION(GetHandle());
  return static_cast<int>(SendMessage(CB_SELECTSTRING, startIndex, TParam2(findStr)));
}
...
inline int TComboBox::SetSelStringExact(LPCTSTR find, int startIndex)
{
  ...
  int index = static_cast<int>(CONST_CAST(TComboBox*,this)->
           SendMessage(CB_FINDSTRINGEXACT, startIndex,reinterpret_cast<LPARAM>(find)));
...
inline int TComboBox::SetItemHeight(int index, int height) {
  PRECONDITION(GetHandle());
  return static_cast<int>(SendMessage(CB_SETITEMHEIGHT, index, MkParam2(height, 0)));
}
