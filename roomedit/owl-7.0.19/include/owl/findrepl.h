...
class _OWLCLASS TFindDialog : public TFindReplaceDialog {
  public:
    TFindDialog(TWindow*        parent,
     ...
     TFindDialog(TWindow* parent, TData& data, TResId templateId, const tstring& title, TModule* = nullptr);
...
class _OWLCLASS TReplaceDialog : public TFindReplaceDialog {
  public:
    TReplaceDialog(TWindow*        parent,
     ...
     TReplaceDialog(TWindow* parent, TData& data, TResId templateId, const tstring& title, TModule* = nullptr);
