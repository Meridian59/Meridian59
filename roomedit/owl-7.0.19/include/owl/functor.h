...
class TMemberTranslatorV1 : public TFunctorV1<P1>{
  public:
    ...
    {
      TCallee* callee = reinterpret_cast<TCallee*>(ftor.Callee);
      TMemFunc& memFunc(*reinterpret_cast<TMemFunc*>((void*)ftor.MemberFunc));
      (callee->*memFunc)(p1);
    }
};
...
class TFunctionTranslator1 : public TFunctor1<R,P1>{
  public:
    TFunctionTranslator1(Funct f) : TFunctor1<R,P1>(Thunk,nullptr,(void*)f,0) {}
...
class TFunctionTranslator3 : public TFunctor3<R,P1,P2,P3>{
  public:
    TFunctionTranslator3(Funct f) : TFunctor3<R,P1,P2,P3>(Thunk,nullptr,(void*)f,0) {}
