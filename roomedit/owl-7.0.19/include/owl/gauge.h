...
///
/// Note: In OWLNext 6.32, this class was deprecated and replaced by TProgressBar.
/// While TGauge is a custom-rendered control, TProgressBar encapsulates the native
/// Windows common control (Progress Bar).
//
