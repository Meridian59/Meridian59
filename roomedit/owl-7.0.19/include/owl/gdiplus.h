...
{
  return TSize(std::lround(v.Width), std::lround(v.Height));
}
...
{
  return TPoint(std::lround(v.X), std::lround(v.Y));
}
...
{
  return TRect(
    TPoint(std::lround(v.X), std::lround(v.Y)),
    TSize(std::lround(v.Width), std::lround(v.Height)));
}
