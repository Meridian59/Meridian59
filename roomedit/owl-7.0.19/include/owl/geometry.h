...
///
/// The constructor assumes that the low-word of the given argument is the horizontal extent and
/// the high-word of the given argument is the vertical extent.
//
inline
