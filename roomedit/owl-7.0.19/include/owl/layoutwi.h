...
/// metrics.X.Set(lmCenter, lmSameAs, lmParent, lmCenter);
/// metrics.Y.Set(lmCenter, lmSameAs, lmParent, lmCenter);
...
class _OWLCLASS TLayoutWindow : virtual public TWindow {
  public:
   ...
   ~TLayoutWindow() override;
    ...
    auto GetChildLayoutMetrics(const TWindow& child) -> TLayoutMetrics;
  ...
  private:
    ...
    TChildMetrics* GetChildMetrics(const TWindow& child);
