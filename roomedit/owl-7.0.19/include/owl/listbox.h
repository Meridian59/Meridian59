...
class _OWLCLASS TListBox : public TControl
{
  public:
    ...
    int           ReplaceString(const tstring& str, int index) {return ReplaceString(str.c_str(), index);}
...
inline int TListBox::GetTopIndex() const {
  ...
  return static_cast<int>(CONST_CAST(TListBox*,this)->SendMessage(LB_GETTOPINDEX));
}
...
inline int TListBox::SetTopIndex(int index) {
  PRECONDITION(GetHandle());
  return static_cast<int>(SendMessage(LB_SETTOPINDEX, index));
}
...
inline bool TListBox::SetTabStops(int numTabs, int * tabs) {
  PRECONDITION(GetHandle());
  return static_cast<bool>(SendMessage(LB_SETTABSTOPS, numTabs, TParam2(tabs)));
}
...
inline int TListBox::GetHorizontalExtent() const {
  PRECONDITION(GetHandle());
  return static_cast<int>(CONST_CAST(TListBox*,this)->SendMessage(LB_GETHORIZONTALEXTENT));
}
...
inline int TListBox::GetCaretIndex() const {
  PRECONDITION(GetHandle());
  return static_cast<int>(CONST_CAST(TListBox*,this)->SendMessage(LB_GETCARETINDEX));
}
...
inline int TListBox::SetCaretIndex(int index, bool partScrollOk) {
  PRECONDITION(GetHandle());
  return static_cast<int>(SendMessage(LB_SETCARETINDEX, index, MkParam2(partScrollOk,0)));
}
...
inline int TListBox::GetItemRect(int index, TRect& rect) const {
  PRECONDITION(GetHandle());
  return static_cast<int>(CONST_CAST(TListBox*,this)->
           SendMessage(LB_GETITEMRECT, index, TParam2(reinterpret_cast<TRect *>(&rect))));
}
...
inline int TListBox::SetItemHeight(int index, int height) {
  PRECONDITION(GetHandle());
  return static_cast<int>(SendMessage(LB_SETITEMHEIGHT, index, MkParam2(height, 0)));
}
...
inline int TListBox::DirectoryList(uint attrs, LPCTSTR fileSpec) {
  PRECONDITION(GetHandle());
  return static_cast<int>(SendMessage(LB_DIR, attrs, TParam2(fileSpec)));
}
...
inline int TListBox::AddString(LPCTSTR str) {
  PRECONDITION(GetHandle());
  return static_cast<int>(SendMessage(LB_ADDSTRING, 0, TParam2(str)));
}
...
inline int TListBox::InsertString(LPCTSTR str, int index) {
  PRECONDITION(GetHandle());
  return static_cast<int>(SendMessage(LB_INSERTSTRING, index, TParam2(str)));
}
...
inline int TListBox::DeleteString(int index) {
  PRECONDITION(GetHandle());
  return static_cast<int>(SendMessage(LB_DELETESTRING, index));
}
...
inline int TListBox::GetCount() const {
  PRECONDITION(GetHandle());
  return static_cast<int>(CONST_CAST(TListBox*,this)->SendMessage(LB_GETCOUNT));
}
...
inline int TListBox::SetSelStringExact(LPCTSTR find, int startIndex) {
  PRECONDITION(GetHandle());
  int index = static_cast<int>(SendMessage(LB_FINDSTRINGEXACT, startIndex, reinterpret_cast<TParam2>(find)));
...
inline int TListBox::GetStringLen(int index) const {
  PRECONDITION(GetHandle());
  return static_cast<int>(CONST_CAST(TListBox*,this)->SendMessage(LB_GETTEXTLEN, index));
}
...
inline bool TListBox::GetSel(int index) const {
  PRECONDITION(GetHandle());
  return static_cast<bool>(CONST_CAST(TListBox*,this)->SendMessage(LB_GETSEL, index));
}
...
{
  PRECONDITION(GetHandle());
  return static_cast<int>(SendMessage(LB_INITSTORAGE, numItemsToAdd, memoryToAllocate));
}
...
{
  PRECONDITION(GetHandle());
  return static_cast<int>(CONST_CAST(TListBox*,this)->SendMessage(LB_GETANCHORINDEX, 0, 0));
}
...
{
  PRECONDITION(GetHandle());
  return static_cast<int>(SendMessage(LB_SETANCHORINDEX, index, 0));
}
