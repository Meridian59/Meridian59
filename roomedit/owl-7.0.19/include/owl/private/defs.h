...
# endif
...
#if defined(_MSC_VER)
    #define OWL_DISABLE_WARNING_PUSH           __pragma(warning( push ))
    #define OWL_DISABLE_WARNING_POP            __pragma(warning( pop )) 
    #define OWL_DISABLE_WARNING(warningNumber) __pragma(warning( disable : warningNumber ))

    #define OWL_DISABLE_WARNING_UNREFERENCED_FORMAL_PARAMETER    OWL_DISABLE_WARNING(4100)
    #define OWL_DISABLE_WARNING_UNREFERENCED_FUNCTION            OWL_DISABLE_WARNING(4505)
    ...
    #define OWL_DO_PRAGMA_(X) _Pragma(#X)
    
  #if defined(__clang__)
    #define OWL_DISABLE_WARNING_PUSH           OWL_DO_PRAGMA_(clang diagnostic push)
    #define OWL_DISABLE_WARNING_POP            OWL_DO_PRAGMA_(clang diagnostic pop) 
    #define OWL_DISABLE_WARNING(warningName)   OWL_DO_PRAGMA_(clang diagnostic ignored #warningName)
  #elif defined(__GNUC__)     
    #define OWL_DISABLE_WARNING_PUSH           OWL_DO_PRAGMA_(GCC diagnostic push)
    #define OWL_DISABLE_WARNING_POP            OWL_DO_PRAGMA_(GCC diagnostic pop) 
    #define OWL_DISABLE_WARNING(warningName)   OWL_DO_PRAGMA_(GCC diagnostic ignored #warningName)
  #endif
    
    #define OWL_DISABLE_WARNING_UNREFERENCED_FORMAL_PARAMETER    OWL_DISABLE_WARNING(-Wunused-parameter)
    #define OWL_DISABLE_WARNING_UNREFERENCED_FUNCTION            OWL_DISABLE_WARNING(-Wunused-function)
    #define OWL_DISABLE_WARNING_EXTENSION                        OWL_DISABLE_WARNING(-Wlanguage-extension-token)
    #define OWL_DISABLE_WARNING_ZERO_AS_NULL_POINTER             OWL_DISABLE_WARNING(-Wzero-as-null-pointer-constant)
    #define OWL_DISABLE_WARNING_OLD_STYLE_CAST                   OWL_DISABLE_WARNING(-Wold-style-cast)
