...
#define GETFUNCTOR(T,func) \
        Functor((TFunctor0<T>*)nullptr, func)
#define PUTFUNCTOR(T,func) \
        Functor((TFunctorV1<T>*)nullptr, func)
#define GETPUTFUNCTOR(T,funcGet,funcPut) \
        Functor((TFunctor0<T>*)nullptr, funcGet),\
        Functor((TFunctorV1<T>*)nullptr, funcPut)
//
#define GETOBJFUNCTOR(T,func) \
        Functor((TFunctor0<T&>*)nullptr, func)
#define PUTOBJFUNCTOR(T,func) \
        Functor((TFunctorV1<const T&>*)nullptr, func)
#define GETPUTOBJFUNCTOR(T,funcGet,funcPut) \
        Functor((TFunctor0<T&>*)nullptr, funcGet),\
        Functor((TFunctorV1<const T&>*)nullptr, funcPut)
//
#define GETMFUNCTOR(T,type,memberFunc) \
        Functor((TFunctor0<T>*)nullptr, *this, &type::memberFunc)
#define PUTMFUNCTOR(T,type,memberFunc) \
        Functor((TFunctorV1<T>*)nullptr, *this, &type::memberFunc)
#define GETPUTMFUNCTOR(T,type,memberGet,memberPut) \
        Functor((TFunctor0<T>*)nullptr, *this, &type::memberGet),\
        Functor((TFunctorV1<T>*)nullptr, *this, &type::memberPut)

#define GETOBJMFUNCTOR(T,type,memberFunc) \
        Functor((TFunctor0<T&>*)nullptr, *this, &type::memberFunc)
#define PUTOBJMFUNCTOR(T,type,memberFunc) \
        Functor((TFunctorV1<const T&>*)nullptr, *this, &type::memberFunc)
#define GETPUTOBJMFUNCTOR(T,type,memberGet,memberPut) \
        Functor((TFunctor0<T&>*)nullptr, *this, &type::memberGet),\
        Functor((TFunctorV1<const T&>*)nullptr, *this, &type::memberPut)
//
#define IDXGETFUNCTOR(T,func) \
        Functor((TFunctor1<T,int>*)nullptr, func)
#define IDXPUTFUNCTOR(T,func) \
        Functor((TFunctorV2<int,T>*)nullptr, func)
#define IDXGETPUTFUNCTOR(T,funcGet,funcPut) \
        Functor((TFunctor1<T,int>*)nullptr, funcGet),\
        Functor((TFunctorV2<int,T>*)nullptr, funcPut)
#define IDXGETPUTOBJFUNCTOR(T,funcGet,funcPut) \
        Functor((TFunctor1<T&,int>*)nullptr, funcGet),\
        Functor((TFunctorV2<int,const T&>*)nullptr, funcPut)
//
#define IDXGETMFUNCTOR(T,type,memberFunc) \
        Functor((TFunctor1<T,int>*)nullptr, *this, &type::memberFunc)
#define IDXPUTMFUNCTOR(T,type,memberFunc) \
        Functor((TFunctorV2<int,T>*)nullptr, *this, &type::memberFunc)
#define IDXGETPUTMFUNCTOR(T,type,memberGet,memberPut) \
        Functor((TFunctor1<T,int>*)nullptr, *this, &type::memberGet),\
        Functor((TFunctorV2<int,T>*)nullptr, *this, &type::memberPut)
#define IDXGETPUTOBJMFUNCTOR(T,type,memberGet,memberPut) \
        Functor((TFunctor1<T,int>*)nullptr, *this, &type::memberGet),\
        Functor((TFunctorV2<int,const T&>*)nullptr, *this, &type::memberPut)
