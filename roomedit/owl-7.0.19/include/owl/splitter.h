...
// ~~~~~ ~~~~~~~~~~~~~~~~~~~~~~
class _OWLCLASS TSplitterIndicatorList: public TBaseList<TSplitterIndicator*>{
  public:
...
{
  TRect  rect = GetRect();
  MapWindowPoints(nullptr, reinterpret_cast<TPoint*>(&rect), 2);  // map to screen
  return rect;
}
