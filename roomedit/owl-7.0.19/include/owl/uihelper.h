...
:
  SourceType(sBitmap), Text(), Bm(&bm), Icon(), Rect(faceRect),BkgndColor(bkgndColor),
...
:
  SourceType(sText), Text(text), Bm(), Icon(), Rect(faceRect), BkgndColor(TColor::None),
...
TUIFace::TUIFace(const TRect& faceRect, const TIcon& icon,
                 const TColor& /*bkgndColor*/, const TColor& fillColor)
:
  SourceType(sIcon), Text(), Bm(), Icon(&icon), Rect(faceRect),
