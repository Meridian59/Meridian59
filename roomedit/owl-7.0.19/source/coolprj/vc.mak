...
#
!if [..\parse_version.bat OWL "..\..\include\owl\version.h" >$(OBJDIR)\COOLPRJ_VERSION.tmp]
! error Unable to detect the CoolPrj version number.
!endif

!include $(OBJDIR)\COOLPRJ_VERSION.tmp
...
!if [del "$(OBJDIR)\COOLPRJ_VERSION.tmp"]
! message Unable to remove temporary file "$(OBJDIR)\COOLPRJ_VERSION.tmp".
!endif
