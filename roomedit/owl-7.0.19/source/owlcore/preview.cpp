...
//
  inline bool SetWindowExt(HDC hdc, int w, int h) {return ::SetWindowExtEx(hdc, w, h, nullptr);}
  inline bool SetWindowOrg(HDC hdc, int w, int h) {return ::SetWindowOrgEx(hdc, w, h, nullptr);}
  inline bool SetViewportExt(HDC hdc, int w, int h) {return ::SetViewportExtEx(hdc, w, h, nullptr);}
...
TPrintPreviewDC::ReScale()
{
  ...
  ::SetMapMode(GetHDC(), MM_ANISOTROPIC);
  ::SetWindowExtEx(GetHDC(), we.cx, we.cy, nullptr);
  ::SetViewportExtEx(GetHDC(), ve.cx, ve.cy, nullptr);
...
TPrintPreviewDC::ReOrg()
{
  ...
  ::SetWindowOrgEx(GetHDC(), wo.x, wo.y, nullptr);
  ::SetViewportOrgEx(GetHDC(), vo.x, vo.y, nullptr);
}
