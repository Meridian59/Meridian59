...
:
  TEventHandler(), Data(nullptr), CurPtr(nullptr), Length(0)
{
}
...
TSerializeReceiver::BlockReceived(TParam1 param1, TParam2 param2)
{
  ...
  //
  *CurPtr++ = static_cast<char>(HiUint8(HiUint16(param2)));

  if (param1 >= TSerializer::Data2)
    *CurPtr++ = static_cast<char>(LoUint8(HiUint16(param2)));

  if (param1 == TSerializer::Data3)
    *CurPtr++ = static_cast<char>(HiUint8(LoUint16(param2)));
