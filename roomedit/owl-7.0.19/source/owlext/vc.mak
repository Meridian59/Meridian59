...
#
!if [..\parse_version.bat OWL "..\..\include\owl\version.h" >$(OBJDIR)\OWLEXT_VERSION.tmp]
! error Unable to detect the OWLExt version number.
!endif

!include $(OBJDIR)\OWLEXT_VERSION.tmp
...
!if [del "$(OBJDIR)\OWLEXT_VERSION.tmp"]
! message Unable to remove temporary file "$(OBJDIR)\OWLEXT_VERSION.tmp".
!endif
