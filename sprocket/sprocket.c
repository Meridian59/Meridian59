...
{ 
	...
	{1, TAG_INT}, {2, LIST_RSC_PARM}, {2, LIST_INT_PARM},
	{2, LIST_INT_PARM}, {2, LIST_INT_PARM}, {0, DONE_PARM} } },
#else // this is from original file in source safe
	{ BP_NEW_CHARINFO,         { {4, TAG_OBJECT}, {0, TAG_TEMP_STRING}, {0, TAG_STRING}, 
...
client_table_type user_table,system_table,usercommand_table;


HANDLE hInst;

/* local function prototypes */
void WINAPI InitSprocket(void);
...
client_table_node * WINAPI GetParseClientTable(int table_type)
{
	switch (table_type)
	{
