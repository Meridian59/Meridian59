...
$result = mysql_query("SELECT player_money_total_amount amount, Date(player_money_total_time) date FROM meridian103.player_money_total GROUP BY date ORDER by date ASC LIMIT 7");
while ($row = mysql_fetch_assoc($result)) {
